...
export function ChatWidget({ onOpen }: { onOpen?: (message?: string) => void }) {
  ...
  return (
    <div className="fixed bottom-[32px] left-1/2 -translate-x-1/2 z-50 w-full max-w-[360px] px-4 sm:px-0">
      <div className="content-stretch flex flex-col gap-[21px] items-start relative size-full">
        ...
        {/* Input Area */}
        <div
          className="bg-white content-stretch flex flex-col items-start relative rounded-[24px] shrink-0 w-full shadow-sm"
        >
            ...
            <div className="flex flex-row items-center size-full">
              <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[16px] relative w-full">
                <textarea
                  ...
                  className="font-uber font-medium leading-[1.7] w-full resize-none outline-none border-none bg-transparent p-0 text-[15px] text-black placeholder:text-[rgba(0,0,0,0.5)] tracking-[0.45px] min-h-[24px] max-h-[120px]"
                  rows={1}
